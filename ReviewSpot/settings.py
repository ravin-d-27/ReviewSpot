"""
Django settings for ReviewSpot project.
...
SECRET_KEY = 'django-insecure-!65j)6gs+)%b&#*^361ra@1#l(2g&=0i)gf0%0c+w2zgdbvrsf'
...
WSGI_APPLICATION = 'ReviewSpot.wsgi.application'
